...
module.exports = [
  ...
  },
  {
    ...
    flightStartDate: moment().add(2, 'weeks').format('MM/DD/YY'),
    flightEndDate: moment().add(10, 'weeks').format('MM/DD/YY'),
    agency: 'Mullberry Way Group',
    lastUpdated: '02/16/17 12:12 PM',
    grossMarketBudget: 53190,
    totalGrpGoal: 940,
    primaryDemo: 'M 18-49',
    lastUpdatedBy: 'John Doe',
  ...
  },
  {
    ...
    flightEndDate: moment().subtract(2, 'weeks').format('MM/DD/YY'),
    agency: 'Auto Advertising Partners',
    lastUpdated: '02/06/17 11:14 AM',
    grossMarketBudget: 53190,
    totalGrpGoal: 94,
    primaryDemo: 'M 18-49',
    lastUpdatedBy: 'John Doe',
  ...
  },
  {
    ...
    market: 'Washington',
    station: 'WVVV',
    expirationDate: '01/04/17',
    flightStartDate: moment().subtract(3, 'weeks').format('MM/DD/YY'),
    flightEndDate: moment().add(1, 'weeks').format('MM/DD/YY'),
    agency: 'Vanthrop & Associates',
    lastUpdated: '01/04/17 10:12 AM',
    grossMarketBudget: 53190,
    totalGrpGoal: 94,
    primaryDemo: 'M 18-49',
    lastUpdatedBy: 'John Doe',
