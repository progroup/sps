  ...
  <section class="section">
    <div class="container">
      <div class="columns">
        <div class="column">
          <b-panel>
            <strong slot="header">Welcome</strong>
            <div class="content">
        ...
        <div class="column">
          <b-panel>
            <strong slot="header">APP State Wide Goals</strong>
            <div class="content">
              <ul>
                <li>
                  <b>Goal 1:</b> Reduce the early onset of alcohol use among 9-20 year olds
                </li>
                <li>
                  <b>Goal 2:</b> Reduce access to alcohol and binge drinking among 9-20 year olds
                </li>
                <li>
                  <b>Goal 3:</b> Reduce binge drinking and heavy drinking among 18-25 year olds
                </li>
              </ul>
            </div>
          </b-panel>
        ...
        <div class="column">
          <b-panel>
            <strong slot="header">We Provide</strong>
            <div class="content">
              <ul>
