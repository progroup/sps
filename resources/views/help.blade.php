@extends('layouts.app')
@section('content')
<section class="hero is-light is-bold" style="background-image: url('/assets/images/banners/help.jpg')">
    <div class="hero-body">
        <div class="container">
        ...
        <div class="columns">
            ...
            <div class="column is-8">
                <div class="content">
                    ...
                    <strong>Krystal:</strong> <a href="mailto:krystal@progroup.us">krystal@progroup.us</a>  678-557-8711</p>
                </div>
            </div>
        </div>
    </div>
