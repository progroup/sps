  ...
  <div class="relative bg-white overflow-hidden">
      ...
      >
          ...
          >
            <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
              <div class="flex items-center justify-between w-full md:w-auto">
                <a href="#">
                  <span class="sr-only">GaSPS</span>
                  <BaseLogo class="text-primary-500" name="ga-sps" />
                </a>
            ...
            <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
              ...
              <a href="#" class="font-medium text-primary-600 hover:text-primary-500">ECCO Log in</a>
            </div>
          </nav>
        </div>
        ...
        >
          <div class="sm:text-center lg:text-left">
            ...
            >
              <!-- <span class="block xl:inline">Welcome to the Georgia Strategic</span>
              <span class="block text-primary-600 xl:inline">Prevention Services Hubsite</span>-->
            </h1>
            <p
              class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0"
            >Welcome to GASPS, the technical assistance system for Georgia’s Alcohol Substance Abuse Prevention Project (ASAPP)</p>
            <div v-if="false" class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
      <img
        ...
        src="https://images.unsplash.com/photo-1534774592507-488885376ad3?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MjB8fGxpYnJhcnklMjBpbnRlcmlvcnxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=60"
        alt
      />
    </div>
  </div>
