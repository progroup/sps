...
export default {
  ...
  setup() {
    ...
    const login = () => {
      ...
      axios.get('/sanctum/csrf-cookie').then((response) => {
        ...
        axios.post('/api/login', {
          ...
          errorMessage.value = error.response.data.errors[key][0]
        })
    ...
    return {
      email, password, errorMessage, login, t
    }
  }
}
</script>
    ...
    <div class="flex min-h-screen bg-white">
      ...
      >
        <div class="w-full max-w-sm mx-auto lg:w-96">
          <div>
            <AppLogo :name="$store.state.affiliate.slug" class="w-11 h-11 text-primary-500" />

            <h2 class="mt-6 text-3xl font-extrabold text-gray-900">{{ t('sign_in') }}</h2>
